		...
		$(document).ready(function(){
			...
			//상세 보기를 위해서 클릭
			 $(document).on("click", "#requestDetail_btn", function(event){
				...
				var url = "main_popup_m.php?num=" + param;
				var windowName = "main_popup_m";
 ...
 <header>
  ...
  <nav>
   <ul class="main_menu bold verd">
    <li><a href="main_m.php" title="item" class="tab_m on">My Page</a></li>
    <li><a href="requestlistOT_m.php" title="retrieve" class="tab_m">Ot Agnet</a></li>
...
<?php
	...
	$sql = "select a.rnum,a.reg_date,a.region,a.category,a.type, (select count(*) from request x where x.refer_rnum = a.rnum  and x.req_type = '02') as rcnt ,a.area_from,a.area_to,a.floor_from,a.floor_to,a.room_from,a.room_to,a.sprice_from,a.sprice_to,a.dprice_from,a.dprice_to,a.rprice_from,a.rprice_to, a.title,a.content,a.status 
	from request a where a.req_type = '01' and a.status = '0' and a.ccode= '$ccode' order by a.rnum desc; ";
	...
	$html_title = "query: ".date("Y-m-d H:i:s")." ".$result->num_rows."cnt"; 
...
?>
			<div class='div_data green'><a href=<?=$row['rnum']?> id="requestDetail_btn">
<?
		}
...
?>
		   ...
		   <div class='div_right'><?=$row['reg_date']?></div>
		</a></div>
	  </li>
