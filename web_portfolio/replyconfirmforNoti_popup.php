		...
		$.ajax({
			...
			success: function(ret_val){
				...
				if($.type(ret_val) === "object" && ret_val.status == "Success" ){
					...
					//부모(request) - 자식(reply) - 손자(replyconfirm)에서 부모와 자식만 파라메터로 넘긴다.
					window.location="replyconfirmforNoti_popup.php?num1="+v_originvalue + "&num2="+v_referrnum;
				}else {
						//alert("not equal");
						$("#add_err").css('display', 'inline', 'important');
								...
								<td height="21" valign="bottom">
									...
									<table border="0" cellpadding="0" cellspacing="0">
										<tr>
											<td class="ttl_ico"></td>
											<td width="5"></td>
											<td class="ttl_text">답장 내용(수신-알람)</td>
											<td width="3"></td>
...
<?php
	...
	//알림에서 받은 답장일 경우 - request와 해당답장만 select한다.
	...
	WHERE t1.rnum ='$num1' and t2.rnum ='$num2';";
									...
									<td width="70%">
										...
										<table border="0" cellpadding="0" cellspacing="0">
											...
											<? if ($row['item_status'] == '0'){  //정상 ?>
												<td><img src="images/money.png"></td><td><span style="vertical-align:middle">정상</span></td> 
											<? }else{ ?>
												<td><img src="images/delete.png"></td><td><span style="vertical-align:middle">종료</span></td>
											<? }?>												
					...
					<td>
						...
						<table id="companyinfo<?=$row['lev2']?>" width="100%" border="0" cellpadding="0" cellspacing="0" class="rct_bg">
							...
							<tr class="ct_ttlc_my">
								...
								<td width="40%" align="right"><?=$row['reg_date2']?></td>
							</tr>
							<tr class="ct_ttlc_my">
						...
						<table id="btngrp<?=$row['lev2']?>" border="0" cellpadding="0" cellspacing="0"  class="confirm_btn_grp" width="100%" >
							<tr>
								<td width="20%" align="left">답장확인</td>
											...
											<td>
												<table  border="0" cellpadding="0" cellspacing="0">
													<tr>
														...
														<td background="images/btn_main_c.gif" class="btn" nowrap><a href=<?=$row['lev2']?> id="r_question_btn">문의</a></td>
									  ...
									  <tr>
										<td width="33%" align="right">
											<table  border="0" cellpadding="0" cellspacing="0">
												<tr>
													<td><img src="images/btn_main_l.gif"></td>
													<td background="images/btn_main_c.gif" class="btn" nowrap><a href=<?=$row['lev2']?> id="r_tel_btn">방문</a></td>
													<td><img src="images/btn_main_r.gif"></td>
												</tr>
											</table>
										</td>
										<td width="33%" align="right">
											<table  border="0" cellpadding="0" cellspacing="0">
												<tr>
													<td><img src="images/btn_main_l.gif"></td>
													<td background="images/btn_main_c.gif" class="btn" nowrap><a href=<?=$row['lev2']?> id="r_pending_btn">연락</a></td>
													<td><img src="images/btn_main_r.gif"></td>
												</tr>
											</table>
										</td>
										<td width="33%" align="right">
											<table  border="0" cellpadding="0" cellspacing="0">
												<tr>
													<td><img src="images/btn_main_l.gif"></td>
													<td background="images/btn_main_c.gif" class="btn" nowrap><a href=<?=$row['lev2']?> id="r_cancel_btn">보류</a></td>
													<td><img src="images/btn_main_r.gif"></td>
												</tr>
											</table>
										</td>
